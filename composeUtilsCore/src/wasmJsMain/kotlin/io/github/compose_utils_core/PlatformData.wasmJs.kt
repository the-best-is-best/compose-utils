...
actual class PlatformData {
    ...
    actual val version: String
        get() = when {
            userAgent.contains("Chrome") -> userAgent.substringAfter("Chrome/").substringBefore(" ")
            userAgent.contains("Firefox") -> userAgent.substringAfter("Firefox/").substringBefore(" ")
            userAgent.contains("Safari") && !userAgent.contains("Chrome") -> userAgent.substringAfter("Version/").substringBefore(" ")
            userAgent.contains("Edge") -> userAgent.substringAfter("Edge/").substringBefore(" ")
            userAgent.contains("Opera") || userAgent.contains("OPR") -> userAgent.substringAfter("OPR/").substringBefore(" ")
            else -> "Unknown"
        }
